  ...
  return (
    <div>
      <nav className="navbar">
        ...
        <div className="navbar__nav-links--active">The Facts</div>
        <div className="navbar__nav-links"><a href="https://letstalk.bell.ca/en/get-help" className="navbar__nav-links">Get Help</a></div>
      </nav>
      <div className="hero">
